...
import { titleTemplate as defaultTitleTemplate } from "pages/_appxxddd";
...
export const Layout = memo<LayoutProps>(
  ({ children, title, head, titleTemplate = defaultTitleTemplate }) => {
        ...
        <header className={styles.header}>
          <div
            className={clsx(styles.headerContent, {
              [styles.home]: router.pathname === "/" && width! > 992,
            })}
          >
            <button
